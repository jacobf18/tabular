...
def build_parser():
    ...
    ###########################################################################
    parser.add_argument(
        "--wandb_log", default=False, type=str2bool, help="Log results using wandb"
    )
    parser.add_argument(
        "--wandb_project", type=str, default="TabICL", help="Wandb project name"
    )
    parser.add_argument("--wandb_name", type=str, default=None, help="Wandb run name")
    parser.add_argument("--wandb_id", type=str, default=None, help="Wandb run ID")
    parser.add_argument(
        "--wandb_dir", type=str, default=None, help="Wandb logging directory"
    )
    parser.add_argument(
        "--wandb_mode",
        default="offline",
        type=str,
        help="Wandb logging mode: online, offline, or disabled",
    )
    ...
    parser.add_argument(
        ...
        default="cuda",
        type=str,
        help="Device for training: cpu, cuda, cuda:0",
    )
    parser.add_argument(
        "--dtype",
        default="float32",
        type=str,
        help="Data type (supported for float16, float32) used for training",
    )
    ...
    parser.add_argument(
        ...
        help="Learning rate scheduler: see optim.py for options.",
    )
    parser.add_argument(
        "--warmup_proportion",
        type=float,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0,
        help="Weight decay / L2 regularization penalty",
    )
    parser.add_argument(
        "--cosine_num_cycles",
        type=int,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0,
        help="Final learning rate for cosine_with_restarts",
    )
    parser.add_argument(
        "--poly_decay_lr_end",
        type=float,
        default=1e-7,
        help="Final learning rate for polynomial decay scheduler",
    )
    parser.add_argument(
        "--poly_decay_power",
        type=float,
        default=1.0,
        help="Power factor for polynomial decay scheduler",
    )
    ...
    parser.add_argument(
        "--min_features", type=int, default=5, help="The minimum number of features"
    )
    parser.add_argument(
        "--max_features", type=int, default=100, help="The maximum number of features"
    )
    parser.add_argument(
        "--max_classes", type=int, default=10, help="The maximum number of classes"
    )
    parser.add_argument(
        "--min_seq_len", type=int, default=None, help="Minimum samples per dataset"
    )
    parser.add_argument(
        "--max_seq_len", type=int, default=1024, help="Maximum samples per dataset"
    )
    parser.add_argument(
        "--log_seq_len",
        default=False,
    ...
    parser.add_argument(
        ...
        default="mix_scm",
        type=str,
        help="Prior type: dummy, mlp_scm, tree_scm, mix_scm",
    )
    parser.add_argument(
        "--prior_device",
        default="cpu",
    ...
    parser.add_argument(
        "--embed_dim", type=int, default=128, help="Base embedding dimension"
    )
    parser.add_argument(
        "--col_num_blocks",
        type=int,
        default=3,
        help="Number of blocks in column embedder",
    )
    parser.add_argument(
        "--col_nhead",
        type=int,
        default=4,
        help="Number of attention heads in column embedder",
    )
    parser.add_argument(
        "--col_num_inds",
        type=int,
        default=128,
        help="Number of inducing points in column embedder",
    )
    parser.add_argument(
        "--freeze_col",
        default=False,
        type=str2bool,
        help="Whether to freeze the column embedder",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Number of blocks in row interactor",
    )
    parser.add_argument(
        "--row_nhead",
        type=int,
        default=8,
        help="Number of attention heads in row interactor",
    )
    parser.add_argument(
        "--row_num_cls",
        type=int,
        default=4,
        help="Number of CLS tokens in row interactor",
    )
    parser.add_argument(
        "--row_rope_base",
        type=float,
        default=100000,
        help="RoPE base value for row interactor",
    )
    parser.add_argument(
        "--freeze_row",
        default=False,
        type=str2bool,
        help="Whether to freeze the row interactor",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=12,
        help="Number of transformer blocks in ICL predictor",
    )
    parser.add_argument(
        "--icl_nhead",
        type=int,
        default=4,
        help="Number of attention heads in ICL predictor",
    )
    parser.add_argument(
        "--freeze_icl",
        default=False,
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Expansion factor for feedforward dimensions",
    )
    parser.add_argument(
        "--dropout", type=float, default=0.0, help="Dropout probability"
    )
    parser.add_argument(
        "--activation", type=str, default="gelu", help="Activation function type"
    )
    parser.add_argument(
        "--norm_first",
        default=True,
        type=str2bool,
        help="If True, use pre-norm transformer architecture",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="Directory for checkpoint saving and loading",
    )
    parser.add_argument(
        "--save_temp_every",
        default=50,
        type=int,
        help="Steps between temporary checkpoints",
    )
    parser.add_argument(
        "--save_perm_every",
        default=5000,
    ...
    parser.add_argument(
        ...
        default=False,
        type=str2bool,
        help="Whether to only load model weights",
    )
